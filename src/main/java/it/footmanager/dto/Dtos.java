...
public class Dtos {
    ...
    public static class CreaUtenteRequest {
        ...
        @NotBlank private String nomeRuolo;   // "STAFF" | "ALLENATORE" | "GIOCATORE" ...
        private String  nome;
    ...
    public static class StatisticheDto {
        ...
        private int goalRigore;        private int goalDiTesta;      private int goalPunizione;
    ...
    public static class AggiornaStatisticheRequest {
        ...
        private Integer goalRigore;        private Integer goalDiTesta;      private Integer goalPunizione;
    ...
    public static class RispostaQuizRequest {
        ...
        @NotBlank private String  rispostaScelta;   // testo libero, confrontato con rispostaCorretta
        @Min(0)   private int     tempoImpiegatoSec;
    }
